...
//used it before without custom hooks;
// const queryClient = useQueryClient();
// const {mutate: loginMutation,isPending,error}=useMutation({
//   mutationFn:login,
//   onSuccess:()=> queryClient.client.invalidateQueries({queryKey:["authUser"]})
// });
    ...
    <div className="h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" data-theme="cupcake">
      ...
      rounded-xl shadow-lg overflow-hidden">
        ...
        <div className=" mb-4 flex items-center justify-start gap-2">
          ...
          <span className="text-3xl font-bold font-momo bg-clip-text text-transparent bg-gradient-to-r
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="form-comtrol w-full space-y-2">
            <label className="label">
