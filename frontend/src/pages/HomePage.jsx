    ...
    <div className="p-4 sm:p-6 space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/notifications" className="btn btn-outline btn-xs gap-1">
      ...
      <div>
        <div className="flex items-center justify-between mb-1">
          <h2 className="text-xl font-semibold tracking-tight">Meet New Learners</h2>
        </div>
        ...
        {loadingUsers ? (
          ...
          <div className="card bg-base-200 p-6 text-center">
            ...
            <p className="text-sm opacity-60">Check back later for new language partners!</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="card-body p-4 space-y-3">
                    ...
                    {/* Bio */}
                    {user.bio && (
                      <p className="text-xs opacity-60 line-clamp-2">{user.bio}</p>
                    )}
