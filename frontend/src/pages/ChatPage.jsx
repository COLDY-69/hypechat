...
//         // Fires for ALL channels the client is watching.
//         // We skip messages sent by the current user, and messages
//         // from the channel the user is actively viewing.
...
//     // Cleanup — disconnect client when component unmounts
//     return () => {
