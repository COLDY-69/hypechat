...
// //     onError: (error) => {
// //        toast.error(error.response.data.message);//shows notification all field required
// //     },
// //   });
...
// //     Sconst randomAvatar = `https://avatar.iran.liara.run/public/${idx}.png`;;
...
// //                 className="input input-vordered w-full pl-10"
...
// import { useMutation, useQueryClient } from "@tanstack/react-query";
// import { toast } from "react-hot-toast";
// import { CameraIcon, MapPinIcon, ShipWheelIcon, ShuffleIcon, Loader2 } from "lucide-react"; // ✅ fix 1
// import { completeOnboarding } from "../lib/api";
// import { LANGUAGES } from "../constants";
...
//   const handleRandomAvatar = () => {
//     const idx = Math.floor(Math.random() * 100) + 1;
//     const randomAvatar = `https://avatar.iran.liara.run/public/${idx}.png`; // ✅ fix 2
//     setFormState({ ...formState, profilePic: randomAvatar });
//     toast.success("Avatar changed successfully");
//   };
...
//       <div className="card bg-base-200 w-full max-w-3xl shadow-xl">
//         <div className="card-body p-6 sm:p-8">
//           <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6"> {/* ✅ fix 3 */}
...
//                 value={formState.bio}
//                 onChange={(e) => setFormState({ ...formState, bio: e.target.value })}
//                 className="textarea textarea-bordered h-24" // ✅ fix 4
//                 placeholder="Tell others about yourself and your language learning goals"
//               />
//             </div>
...
//                   value={formState.location}
//                   onChange={(e) => setFormState({ ...formState, location: e.target.value })}
//                   className="input input-bordered w-full pl-10" // ✅ fix 5
//                   placeholder="City, Country"
//                 />
//               </div>
//             </div>
...
//               ) : (
//                 <>
//                   <Loader2 className="animate-spin size-5 mr-2" /> {/* ✅ fix 1 */}
//                   Onboarding...
//                 </>
//               )}
//             </button>
...
import { useMutation, useQueryClient } from "@tanstack/react-query";
import { toast } from "react-hot-toast";
import { CameraIcon, MapPinIcon, ShipWheelIcon, ShuffleIcon, Loader2 } from "lucide-react";
import { completeOnboarding } from "../lib/api";
import { LANGUAGES } from "../constants";
